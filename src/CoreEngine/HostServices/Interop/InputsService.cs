...
namespace CoreEngine.HostServices.Interop
{
    ...
    public struct InputsService : IInputsService
    {
        ...
        private InputsService_GetInputsStateDelegate inputsService_GetInputsStateDelegate
        {
            get;
        }
        ...
        private InputsService_SendVibrationCommandDelegate inputsService_SendVibrationCommandDelegate
        {
            get;
        }
