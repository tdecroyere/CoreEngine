...
namespace CoreEngine.Rendering
{
    ...
    public class RenderManager : SystemManager, IDisposable
    {
        ...
        private void DrawDebugMessages()
        {
            ...
            this.Graphics2DRenderer.DrawText($"    Meshlets: {this.MeshletCount.ToString("0,000", CultureInfo.InvariantCulture)} (Mesh Count: {this.MeshCount}, Instance Count: {this.MeshInstanceCount}, Triangle Count: {this.TriangleCount.ToString("0,000", CultureInfo.InvariantCulture)})", new Vector2(10, 210));
